...
export default function UpComing() {
  return (
    <section
      className="upComing defaultFlex defaultWidth flexJustifyAround"
    ...
    >
      <div style={{ width: "100%", maxWidth: "46rem" }}>
        ...
        <p style={{ color: "white" }}>
          ...
          powerful factions that watch your every step inside the Council Hall.
        </p>
        <p style={{ color: "white" }}>Release Date: 20 Sep, 2024</p>
      </div>
      <div style={{ width: "100%", maxWidth: "46rem" }}>
        ...
        <p style={{ color: "white" }}>Release Date: 2025</p>
      </div>
    </section>
  );
}
